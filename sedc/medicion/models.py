...
class Medicion(models.Model):
    ...
    med_valor=models.DecimalField("Valor",max_digits=14,decimal_places=6)
    med_maximo=models.DecimalField("Máximo",max_digits=14,decimal_places=6)
    med_minimo=models.DecimalField("Mínimo",max_digits=14,decimal_places=6)
    med_validado=models.DecimalField("Validado",max_digits=14,decimal_places=6)
